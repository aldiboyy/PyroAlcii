...
ALIVE_LOGO = getenv("ALIVE_LOGO", "https://telegra.ph/file/7f9df89edcd749ac57b02.jpg")
...
REPO_URL = getenv(
    "REPO_URL",
    b64decode("aHR0cHM6Ly9naXRodWIuY29tL2FsZGlib3l5L1B5cm9BbGNpaS5naXQ=").decode("utf-8"),
)
